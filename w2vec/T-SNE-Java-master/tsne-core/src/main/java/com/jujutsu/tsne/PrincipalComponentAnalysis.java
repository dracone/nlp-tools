...
public class PrincipalComponentAnalysis {
    ...
    public void addSample( double[] sampleData ) {
   	   System.out.println("A.getNumCols() != sampleData.length ="+A.getNumCols()+" - "+sampleData.length );
    ...
    public void computeBasis( int numComponents ) {
    	 ...
    	 System.out.println("="+numComponents+" - "+A.getNumCols()+"-"+ A.getNumRows()+"--"+ sampleIndex);
        ...
        System.out.println("="+A.numRows+","+ A.numCols); 
